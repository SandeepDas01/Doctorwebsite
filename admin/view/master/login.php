...
<!-- Mirrored from www.keenthemes.com/preview/metronic/theme/admin_1/page_user_lock_1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 May 2016 17:14:04 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
        <meta charset="utf-8" />
        <title>Fitness Freak | Admin Panel</title>
	...
	<body class="">
        <div class="page-lock">
            <div class="page-logo">
						...
						?>
                <img style="width:40%;" src="assets/images/logo.png" class="lock-avatar"> 
            </div>
            <div class="page-body">
            ...
            <div class="page-footer-custom"> 2016 &copy; </div>
        </div>
        <!--[if lt IE 9]>
