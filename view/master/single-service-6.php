				...
				<div class="col-lg-3 col-md-3">
					<div class="service_sideber">
						...
						<div class="services_lis">
							<ul>
								<li><a href="health-care.html"><i class="fa fa-check"></i> Cleanings</a></li>
								<li><a href="heart-treatment.html"><i class="fa fa-check"></i> Crowns & bridges</a></li>
								<li><a href="neuro.html"><i class="fa fa-check"></i> Available Lab</a></li>
								<li><a href="eye.html"><i class="fa fa-check"></i> Root canals</a></li>
								<li><a href="kidney.html"><i class="fa fa-check"></i> Cosmetic dentistry</a></li>
								<li><a href="dental.html"><i class="fa fa-check"></i> Dental Treatment</a></li>
							</ul>
						</div>
